...
import { FURNITURE_PURCHASE_LOG_OVERVIEW_TOP_POINTS_QUERY, FurniturePurchaseLogOverviewTopPointsQueryResponse, FurniturePurchaseLogOverviewTopPointsQueryVariables } from "./furniture-purchase-log-overview-top-points.query";
...
export function useFurniturePurchaseLogOverviewTopPoints(): UseFurniturePurchaseLogOverviewTopPointsResponse {
  const [getFurniturePurchaseLogOverviews, { loading, error, data }] = useLazyQuery<FurniturePurchaseLogOverviewTopPointsQueryResponse, FurniturePurchaseLogOverviewTopPointsQueryVariables>(FURNITURE_PURCHASE_LOG_OVERVIEW_TOP_POINTS_QUERY);
