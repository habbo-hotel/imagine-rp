...
import { FURNITURE_PURCHASE_LOG_FETCH_ONE_QUERY } from "../furniture-purchase-log/furniture-purchase-log-fetch-one.query";
import { FurniturePurchaseLogOverviewFetchOneQueryResponse, FurniturePurchaseLogOverviewFetchOneQueryVariables } from "./furniture-purchase-log-overview-fetch-one.query";
...
export function useFurniturePurchaseLogOverviewFetchOne(): UseFurniturePurchaseLogOverviewFetchOneResponse {
  const [getFurniturePurchaseLogOverviews, { loading, error, data }] = useLazyQuery<FurniturePurchaseLogOverviewFetchOneQueryResponse, FurniturePurchaseLogOverviewFetchOneQueryVariables>(FURNITURE_PURCHASE_LOG_FETCH_ONE_QUERY);
