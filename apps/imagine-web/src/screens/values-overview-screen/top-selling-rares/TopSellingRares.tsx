...
import { usefurniturePurchaseLogsOverviewTopSells } from '@imagine-cms/client';
...
export function TopSellingRares() {
  ...
  const fetchTopSelling = usefurniturePurchaseLogsOverviewTopSells();
